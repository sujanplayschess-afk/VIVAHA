     ...
     */
     public function update(Request $request, $id)
     {
         ...
         if(empty($spiritual_backgrounds)){
          ...
          $spiritual_backgrounds->gotra              = $request->gotra;
          $spiritual_backgrounds->manglik            = $request->manglik;
          $spiritual_backgrounds->star_nakshatra     = $request->star_nakshatra;
          $spiritual_backgrounds->rashi_zodiac       = $request->rashi_zodiac;
