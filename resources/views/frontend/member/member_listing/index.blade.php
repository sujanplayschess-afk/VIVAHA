                                ...
                                <div class="row no-gutters border border-gray-300 rounded hov-shadow-md mb-4 has-transition position-relative" id="block_id_{{ $user->id }}">
                                    ...
                                    <div class="col-md position-static d-flex align-items-center">
                                        <span class="absolute-top-right px-4 py-3">
                                            ...
                                            <span class="badge badge-inline badge-warning text-white"><i class="fa-solid fa-crown me-1"></i>{{ translate('Priority') }}</span>
                                            @endif
                                        </span>
                                        <div class="px-md-4 p-3 flex-grow-1">
                                            ...
                                            <h2 class="h6 fw-600 fs-18 text-truncate mb-1">
                                                ...
                                                @if($user->documents_verified_at)
                                                    <i class="fa-solid fa-circle-check text-primary ms-1" title="{{ translate('Verified Member') }}"></i>
                                                @endif
                                            </h2>
                                            ...
                                            <table class="w-100 opacity-70 mb-2 fs-12">
                                                ...
                                                <tr>
                                                    <td class="py-1"><span>{{ translate('Matchmaker') }}</span></td>
                                                    <td class="py-1 fw-400">
                                                        <span class="badge badge-inline badge-soft-primary"><i class="fa-solid fa-user-tie me-1"></i>{{ translate('Human Assisted') }}</span>
                                                    </td>
                                                </tr>
                                                @endif
                                            </table>
