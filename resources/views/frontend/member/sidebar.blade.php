    ...
    <div class="aiz-user-sidenav rounded overflow-hidden">
        ...
        <div class="sidemnenu mb-3">
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('member.photo_view_requests_index') }}" class="aiz-side-nav-link">
                        <i class="las la-image-pointer aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Photo View Requests') }}</span>
                    </a>
                </li>
