            ...
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="javascript:void(0);" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text">{{translate('Premium Management')}}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('premium.verification_index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Member Verification')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('premium.matchmakers_index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Assisted Matchmaking')}}</span>
                            </a>
                        </li>
                    </ul>
                </li>
