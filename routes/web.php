...
Route::group(['middleware' => ['member','verified']], function(){
    ...
    // Photo View Request
    Route::post('/member/photo-view-request', 'MemberController@photo_view_request')->name('member.photo_view_request');
    Route::get('/member/photo-view-requests', 'MemberController@photo_view_requests_index')->name('member.photo_view_requests_index');
    Route::post('/member/photo-view-request-accept', 'MemberController@photo_view_request_accept')->name('member.photo_view_request_accept');
    Route::post('/member/photo-view-request-reject', 'MemberController@photo_view_request_reject')->name('member.photo_view_request_reject');
