...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    // Premium Management
    Route::get('/premium-management/verification', 'PremiumMemberController@verification_index')->name('premium.verification_index');
    Route::post('/premium-management/verify', 'PremiumMemberController@verify_member')->name('premium.verify_member');
    Route::get('/premium-management/matchmakers', 'PremiumMemberController@matchmakers_index')->name('premium.matchmakers_index');
    Route::post('/premium-management/assign-matchmaker', 'PremiumMemberController@assign_matchmaker')->name('premium.assign_matchmaker');
    Route::post('/premium-management/update-priority', 'PremiumMemberController@update_priority')->name('premium.update_priority');
